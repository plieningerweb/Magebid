<?php
/**
 * Mbid_Magebid_Block_Adminhtml_Export_Edit_Tab_Profile
 *
 * @category  Mbid
...
*/
class Mbid_Magebid_Block_Adminhtml_Export_Edit_Tab_Profile extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Prepare Form
     *
    ...
    protected function _prepareForm()
    {
		...
		$fieldset->addField('condition_id', 'select', array(
			...
			'note'		=> Mage::helper('magebid')->__('Please select a category to choose this value. If above is an error message to update the profile, this field does not work correctly.'),
        ));
